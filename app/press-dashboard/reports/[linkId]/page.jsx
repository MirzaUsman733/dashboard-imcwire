  ...
  const fetchPlans = async () => {
    try {
      ...
      if (response.ok) {
        ...
        if (plansData?.formData?.user?.user?.email === sessionEmail) {
        ...
        {plans && filterData && (
          <div className="px-4 py-8">
            ...
            <div>
              ...
              <div className="mt-5">
                <h1 className="text-3xl font-serif font-bold text-purple-800 text-center my-5">
                  Follow Us
                </h1>
...
// const modifiedPdfName = pdfName?.substring(pdfName.indexOf('pdf/') + 4 + 14); // Remove the first 14 digits after 'pdf/'
// console.log("Modified Pdf Name",modifiedPdfName)
// const excelName = filterData?.pdf;
// const modifiedExcelName = excelName?.substring(excelName.indexOf('pdf/') + 4 + 14); // Remove the first 14 digits after 'pdf/'
// console.log("Modified Pdf Name",modifiedPdfName)
