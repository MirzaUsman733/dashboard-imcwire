    ...
    <div class="w-full lg:flex-1 p-8">
      <div class="flex flex-col justify-center px-4 text-center h-full">
        <div class="max-w-xl mx-auto">
          ...
          <div className='mb-5  '>
          <p className="text-lg text-gray-600 mb-6">Check Your order status:</p>
                 {paymentStatus === 'Checking...' ? (
                    <div className="flex justify-center items-center">
                        <ClipLoader color="#4A90E2" loading={true} size={50} />
                    </div>
          ...
          <a href="#" class="bg-gray-900 rounded-full hover:bg-gray-800 focus:ring-4 focus:ring-gray-200 text-white text-xs font-semibold px-4 h-9 inline-flex items-center transition duration-200">Visit Our Online Shop</a>
        </div>
      </div>
    </div>
  </div>
