            ...
            <div className="mt-5">
              ...
              <div className="mt-5 flex flex-wrap justify-center gap-5">
                <Link
                  ...
                  href="https://www.facebook.com/profile.php?id=61551541610947"
                  target="_blank"
                >
                  <svg
                ...
                <Link
                  ...
                  href="https://instagram.com/imcwire?igshid=OGQ5ZDc2ODk2ZA=="
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <Link
                  className="google border border-1 px-5 py-3 rounded-lg bg-gradient-to-tr to-white from-white flex gap-2 text-gray-700 hover:text-white align-center "
                  href="https://instagram.com/imcwire?igshid=OGQ5ZDc2ODk2ZA=="
                  target="_blank"
                >
                  <svg
